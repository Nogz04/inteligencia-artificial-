//Transformar em Python o código do HLAC que está em JAVA
...
public class HLAC implements Estado {
     ...
     */
    @Override
    public List<Estado> sucessores() { //Visitados
    ...
    private void levarNada(List<Estado> suc) {
        ...
        if (novo.ehValido() && !suc.constains(novo) ) { // 
            suc.add(novo);
        } else{
            System.gc();
        }
    ...
    public String toString() {
        ...
        // return "( " + this.homem + this.lobo + this.carneiro + this.alface + ")";
    }
...
//Para reescrever o hash tem que mudar o metodo do sucessores (visitados) e mexer no equals e toString()
